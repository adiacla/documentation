...
pressing :guilabel:`Process Now`, the document will be successfully signed by the government. The
document will now have a :guilabel:`Fiscal Folio`, and the XML file will be attached in the chatter,
which you can see on the right side of the invoice.
...
.. image:: mexico/mx-signed-complement.png
   :align: center
   :alt: CFDI (4.0) E-invoicing service proccess payment now message.
...
or `NNN.YY.ZZZ`. Some examples are `102.01.99` or `401.01.001`.
